...
#'
#' This method adds or overwrites a slot of a \code{MultiDataSet} with the 
#' content of the given \code{eSet}.
#'
#' @rdname add_eset
#' @aliases add_eset
#' @param object \code{MultiDataSet} that will be filled.
#' @param set Object derived from \code{eSet} to be used to fill the slot.
#' @param dataset.type Character with the type of data of the omic set (e.g. 
#' expression, methylation...)
#' @param dataset.name Character with the specific name for this set (NULL by 
#' default). It is useful when there
...
#' @param overwrite Logical to indicate if the set stored in the slot will be 
#' overwritten.
#' @param GRanges \code{GenomicRanges} to be included in rowRanges slot.
#' @return A new \code{MultiDataSet} with a slot filled.
#' @seealso \code{\link{add_methy}}, \code{\link{add_genexp}}, 
#' \code{\link{add_rnaseq}}, \code{\link{add_snps}}
...
#' \code{MultiDataSet} with the content of the given \code{ExpressionSet}. The 
#' fData of the \code{ExpressionSet} must contain the columns chromosome, start
#' and end.
#'
#' @aliases add_genexp
#' @rdname add_genexp
...
#' fData(eset) <- data.frame(chromosome = c("chr1", "chr2"), 
#'   start = c(12414, 1234321), end = c(121241, 124124114), 
...
#' eset <- new("ExpressionSet", exprs = matrix(runif(4), 2))
#' fData(eset) <- data.frame(chromosome = c("chr1", "chr2"), 
#'   start = c(12414, 1234321), end = c(121241, 12122414), 
#'   stringsAsFactors = FALSE)
#' multi <- add_genexp(multi, eset)
setGeneric("add_rnaseq", function(object, rnaSet, ...) 
...
#' \code{MultiDataSet} with the content of the given \code{MethylationSet} or 
#' \code{RatioSet}.
#' The fData of the input object must contain the columns chromosome and 
#' position.
#'
#' @rdname add_methy
#' @aliases add_methy
#' @param object \code{MultiDataSet} that will be filled.
#' @param methySet \code{MethylationSet} or \code{RatioSet} to be used to fill 
#' the slot.
...
#'
#' This method adds or overwrites a slot of a \code{MultiDataSet} with the 
#' content of the given  \code{RangedSummarizedExperiment}.
#'
#' @rdname add_rse
#' @aliases add_rse
#' @param object \code{MultiDataSet} that will be filled.
#' @param set Object derived from \code{RangedSummarizedExperiment} to be used 
#' to fill the slot.
#' @param dataset.type Character with the type of data of the omic set (e.g. 
#' expression, methylation...)
#' @param dataset.name Character with the specific name for this set (NULL by 
#' default). It is useful when there are several sets of the same type (e.g. 
#' multiple expression assays)
#' @param warnings Logical to indicate if warnings will be displayed.
#' @param overwrite Logical to indicate if the set stored in the slot will be 
#' overwritten.
#' @return A new \code{MultiDataSet} with a slot filled.
...
#'
#' This method adds or overwrites a slot of a \code{MultiDataSet} with the 
#' content of the given \code{SummarizedExperiment}.
#'
#' @rdname add_se
#' @aliases add_se
#' @param object \code{MultiDataSet} that will be filled.
#' @param set Object derived from \code{SummarizedExperiment} to be used to 
#' fill the slot.
#' @param dataset.type Character with the type of data of the omic set (e.g. 
#' expression, methylation...)
#' @param dataset.name Character with the specific name for this set (NULL by 
...
#' \code{MultiDataSet} with the content of the given \code{SnpSet}. The fData 
#' of the \code{SnpSet} must contain the columns chromosome and position.
#'
#' @rdname add_snps
#' @aliases add_snps
#' @param object \code{MultiDataSet} that will be filled.
...
#' map <- AnnotatedDataFrame(data.frame(chromosome = c("chr1", "chr2"), 
#'   position = c(12414, 1234321), stringsAsFactors = FALSE))
...
#'
#' This method adds or overwrites a slot of a \code{MultiDataSet} with the 
#' content of the given \code{matrix}.
#'
#' @rdname add_table
#' @aliases add_table
#' @param object \code{MultiDataSet} that will be filled.
...
#' Get the name of the ids common to all datasets in a \code{MultiDataSet}
#' object
#'
#' @rdname commonIds
#' @aliases commonIds
...
#' Method to select samples that are present in all datasets in a 
...
#' @param object \code{MultiDataSet} that will be filtered.
#' @param unify.names Logical indicating if sample names of the sets should 
#' be unified.
...
#' multi <- add_genexp(multi, eset, dataset.name="g2")
#' commonSamples(multi)
setGeneric("commonSamples", function(object, unify.names = FALSE) 
    standardGeneric("commonSamples"))



#' Get the name of the datasets that have rowRanges in a \code{MultiDataSet}
#' object
#'
...
#' @export
setGeneric("rowRangesElements", function(object) 
    standardGeneric("rowRangesElements"))

## ------------------------------------------------------------------------- ##

#' Apply iClusterPlus clustering method to a MultiDataSet object
#'
#' Method \link[iClusterPlus]{iClusterPlus} is applied on a \link{MultiDataSet}
#' object after getting the common samples along all the contained datasets.
#'
...
#' @note Argument \code{type} for \link[iClusterPlus]{iClusterPlus} is filled 
#' within the method.
...
#'
#' Method \link[omicade4]{mcia} is applied on a \link{MultiDataSet} object 
#' after getting the common samples along all the contained datasets.
#'
#' @rdname w_mcia
#' @aliases w_mcia
#' @param object \code{MultiDataSet}
