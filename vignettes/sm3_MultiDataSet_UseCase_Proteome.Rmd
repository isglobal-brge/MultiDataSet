...
write.table(fdata, file="feature_data.tsv", sep="\t", row.names=F, col.names=T, quote=F)
write.table(pdata, file="pheno_data.tsv", sep="\t", row.names=F, col.names=T, quote=F)
write.table(adata, file="assay_data.tsv", sep="\t", row.names=F, col.names=T, quote=F)
